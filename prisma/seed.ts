...
async function main() {
	...
	await prisma.edge.upsert({
		where: { sourceId_targetId_type: { sourceId: 'node-grandpa-id', targetId: 'node-grandma-id', type: 'SPOUSE' } },
		update: {},
		create: {
	...
	await prisma.edge.upsert({
		where: { sourceId_targetId_type: { sourceId: 'node-father-id', targetId: 'node-mother-id', type: 'SPOUSE' } },
		update: {},
		create: {
	...
	await prisma.edge.upsert({
		where: { sourceId_targetId_type: { sourceId: 'node-grandpa-id', targetId: 'node-father-id', type: 'PARENT_CHILD' } },
		update: {},
		create: {
	...
	await prisma.edge.upsert({
		where: { sourceId_targetId_type: { sourceId: 'node-grandpa-id', targetId: 'node-uncle-id', type: 'PARENT_CHILD' } },
		update: {},
		create: {
			id: 'edge-gp-uncle-id',
			sourceId: 'node-grandpa-id',
	...
	await prisma.edge.upsert({
		where: { sourceId_targetId_type: { sourceId: 'node-father-id', targetId: 'node-self-id', type: 'PARENT_CHILD' } },
		update: {},
		create: {
	...
	await prisma.edge.upsert({
		where: { sourceId_targetId_type: { sourceId: 'node-mother-id', targetId: 'node-self-id', type: 'PARENT_CHILD' } },
		update: {},
		create: {
